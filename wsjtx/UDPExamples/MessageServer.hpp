...
public:
  ...
  // ask the client with identification 'id' to enable transmitting
  Q_SLOT void setup_tx (QString const& id, quint32 nextMsgIdx);         //avt 11/16/20
  ...
  Q_SIGNAL void status_update (QString const& id, Frequency, QString const& mode, QString const& dx_call
                               ...
                               , QString const& lastTxMsg, quint32 qsoProgress, bool txFirst);    //avt 11/19/20);
